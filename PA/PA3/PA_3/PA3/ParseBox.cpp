...
ParseBox::ParseBox(){
	...
	//commaDecNumber =regex ("^[a-zA-Z]*(([0-9]+[\\.,]{1}[0-9]+)+([\\.,]{1}[0-9]+)*)|(([0-9]*[\\.]{1}[0-9]+)+([\\.,]{1}[0-9]+)*[a-zA-Z0-9']*)");
	commaDecNumber =regex("([0-9]*[\\.]{0,1}[0-9]+)*(([0-9]*[\\.]{0,1}[0-9]+)+([\\.,]{0,1}[0-9]+)*|([a-zA-Z0-9']*[0-9]+[\\.,]{0,1}[0-9]+)*)*[a-zA-Z'0-9]*");
		//"([0-9]*([\\.]{0,1}[0-9]+)*[a-zA-Z'0-9]*(([0-9]+)+[\\.,]{0,1}[0-9]+[a-zA-Z'0-9]*)*[a-zA-Z0-9']*)|([0-9]*([\\.]{0,1}[0-9]+)+(([a-zA-Z'0-9]*[0-9]+)*[\\.,]{0,1}[0-9]+[a-zA-Z0-9']*[0-9]+)*[a-zA-Z0-9']*)");
		//"[0-9]*([\\.]{0,1}[0-9]+)*(([a-zA-Z'0-9]*[0-9]+)*[\\.,]{0,1}[0-9]+)*[a-zA-Z0-9']*");
	//("[a-zA-Z0-9']*[[0-9]+[\\.,]{1}[0-9]+[a-zA-Z'0-9]*]+|[0-9]*[[\\.]{1}[0-9]+]*[a-zA-Z0-9']*[[0-9]+([\\.,]{1}[0-9]+)*[a-zA-Z0-9']*]*|[0-9]*[\\.]{1}[[0-9]+[\\.,]{1}[0-9]+[a-zA-Z0-9']*]*");
	...
	commaDecNumberDS =regex ("(([0-9]*[\\.]{0,1}[0-9]+)*(([0-9]*[\\.]{0,1}[0-9]+)+([\\.,]{0,1}[0-9]+)*|([a-zA-Z0-9']*[0-9]+[\\.,]{0,1}[0-9]+)*)*[a-zA-Z'0-9]*)(.*)");
		//"(([0-9]*([\\.]{0,1}[0-9]+)*(([a-zA-Z'0-9]*[0-9]+)+[\\.,]{0,1}[0-9]+)*[a-zA-Z0-9']*)|([0-9]*([\\.]{0,1}[0-9]+)+(([a-zA-Z'0-9]*[0-9]+)*[\\.,]{0,1}[0-9]+)*[a-zA-Z0-9']*))(.*)");
		//"(([0-9]*([\\.]{0,1}[0-9]+)*(([a-zA-Z'0-9]*[0-9]+)*)[\\.,]{0,1}[0-9]+)*[a-zA-Z0-9']*)(.*)");
	
	// Having trouble not accepting preceding commas correctly, tidy up
	purePuncDS= regex("(^[^a-zA-Z0-9']+)(.*)");
	puncDecNumLazy = regex("(^[^a-zA-Z0-9']+)(\\.[0-9]+.*)");
	//these for checking capitalization and punctuation
	startCapOnlyCap =regex("[A-Z]{1}[a-z']*"); // need to clear up ambiguouty of marking capital start of sentence characters properly
	puncOnlyEos =regex ("[^a-zA-Z0-9']*[\\.!\\?]+[^a-zA-Z0-9']*");
	numDotFirst = regex("[\\.]{1}[0-9]+(([a-zA-Z'0-9]*[0-9]+)*([\\.,][0-9]+)*)*[a-zA-Z'0-9]*");
		//"[\\.]{1}[0-9]+([a-zA-Z'0-9]*[0-9]+[\\.,][0-9]+[a-zA-Z'0-9]*)*");
	numDotFirstDS = regex("([\\.]{1}[0-9]+(([a-zA-Z'0-9]*[0-9]+)*([\\.,][0-9]+)*)*[a-zA-Z'0-9]*)(.*)");
		//"([\\.]{1}[0-9]+([a-zA-Z'0-9]*[0-9]+[\\.,][0-9]+[a-zA-Z'0-9]*)*)(.*)");
	//"[\\.]{1}[0-9]+(([a-zA-Z'0-9]*[0-9]+)*([\\.,][0-9]+)*)*[a-zA-Z'0-9]*"
	numWithPunc = regex("(([a-zA-Z'0-9]*[0-9]+)+([\\.,][0-9]+)*)*[a-zA-Z'0-9]*");
		//"([a-zA-Z'0-9]*[0-9]+[\\.,]{1}[0-9]+[a-zA-Z'0-9]*)*");
